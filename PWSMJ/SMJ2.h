...
// Sort Merge Join, Partition Phase use Replacement Selection
...
protected:
	...
	struct SmjReport
	{
		...
		UINT64 SourceTableSizeR, SourceTableSizeS; 
		UINT64 PartitionTimeR, PartitionTimeS, TotalPartitionTime; 
		DWORD  PartitionNumR, PartitionNumS; 
		DWORD  MergePassR, MergePassS; 
		UINT64 MergeTimeR, MergeTimeS, TotalMergeTime;  
		DWORD  HeapSizeR, HeapSizeS;
		UINT64 JoinTime; 
		UINT64 TotalTime;
		...
		SmjReport()
		{
			TotalCpuTime[0] = 0;TotalCpuTime[1] = 0;
			SourceTableSizeR = 0; SourceTableSizeS = 0; 
			PartitionTimeR = 0; PartitionTimeS = 0; 
			TotalPartitionTime = 0;
			PartitionNumR = 0; PartitionNumS = 0;
			MergePassR = 1; MergePassS = 1;
			MergeTimeR = 0; MergeTimeS = 0;
			TotalMergeTime = 0; 
			HeapSizeR = 0;HeapSizeS = 0;
			JoinTime = 0; 
			TotalTime = 0;
			BufferPoolSize = 0;
...
protected: 
	...
	RC WriteReport();
public:
	SMJ2(const SMJ2_PARAMS vParams);
	~SMJ2();
